        ...
        <article className="w-3/4 py-6 pr-8">
          <div className="flex flex-col gap-y-4">
            {threads.threads.map((t) => (
              <div
                key={t.id}
                className="flex w-full rounded-lg border bg-white shadow-sm duration-700 hover:shadow-md"
              >
                <div className="flex flex-col items-center justify-start gap-2 p-5 pr-0">
                  ...
                  <div>
                    <span>
                      {Number(t.upVotesBy.length - t.downVotesBy.length)}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5 ">
                  <div className="inline-flex w-full text-sm">
                    Diposting oleh
                    <span className="ml-2 font-semibold">{t.ownerId}</span>
                  </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    | <span>{t.totalComments} Komentar</span>
                  </div>
                </div>
              </div>
            ))}
